...
class YST360IE(InfoExtractor):
    IE_NAME = 'YST360'
    # https://evoload.io/v/58AtgpYn5tAKEp
    _VALID_URL = r'https?://www\.360-yst\.com/vplay/(?P<id>[a-zA-Z0-9]+)/?'
    _TEST = {}
    TITLE_RE = (
    ...
    def _real_extract(self, url):
        ...
        webpage_video = self._download_webpage(url, video_id, note='Downloading video page')
