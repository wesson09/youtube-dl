...
class InfoExtractor(object):
    ...
    def _parse_mpd_formats(self, mpd_doc, mpd_id=None, mpd_base_url='', mpd_url=None):
        ...
        DRMIdentifiers = {'6dd8b3c3-45f4-4a68-bf3a-64168d01a4a6':'ABV DRM (MoDRM)',
        ...
        def get_drm_message(protect_elements):
            ...
            #protect_elements = element.findall(_add_ns('ContentProtection'))
                ...
                try:
                    ...
                    if schemeIdUri is not None and schemeIdUri.startswith('urn:uuid'):
                        ...
                        try:
                          ...
                          drmmsg = drmmsg + ' Unknown Licencing';
                except:
                    continue
            return drmmsg
        ...
        for period in mpd_doc.findall(_add_ns('Period')):
            ...
            for adaptation_set in period.findall(_add_ns('AdaptationSet')):
                ...
                for representation in adaptation_set.findall(_add_ns('Representation')):
                    protects = get_drm_protections(representation)
                    if len(protects) > 0:
                        drmmsg = get_drm_message(protects)
                        self.raise_drm_restricted(drmmsg)
